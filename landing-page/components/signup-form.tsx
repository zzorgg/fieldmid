...
export default function SignUpForm() {
    ...
    const isRedirecting = useAuthStore((state) => state.authenticatingProvider)
    ...
    async function handleGithubSignIn() {
        ...
        await signInWithGithub(`${window.location.origin}${redirectPath}`)
    }
                ...
                <div className="p-8 pb-6">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <Button
                            ...
                            <span>{isRedirecting === 'github' ? 'Redirecting...' : 'GitHub'}</span>
                        </Button>
                    </div>
